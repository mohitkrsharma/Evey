...
import { MatButtonModule, MatCheckboxModule, MatInputModule, MatRadioModule, MatSlideToggle, MatSlideToggleModule } from '@angular/material';
...
const routes: Routes = [{ path: '', data:{ breadcrumb: null}, component: ListComponent }];
