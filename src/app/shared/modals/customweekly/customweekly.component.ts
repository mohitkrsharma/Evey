...
@Component({
  selector: 'app-custom-weekly',
  templateUrl: './customweekly.component.html',
  styleUrls: ['./customweekly.component.scss']
})
export class CustomWeeklyComponent implements OnInit {
  ...
  constructor(private _apiService: ApiService,
    ...
    public _dialogRef: MatDialogRef<CustomWeeklyComponent>,
